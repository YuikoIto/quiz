  ...
  public function run()
  {
    ...
    DB::table('answers')->insert([
      [
        ...
        'correct_answer_no' => 1,
        'commentary' => 
        'PCはPersonal Computer(パーソナルコンピュータ)の略称である。
      ...
      [
        ...
        'correct_answer_no' => 3,
        'commentary' => 
        'アプリケーションをコンピュータで使用可能にするための作業のことをインストールと言う。
      ...
      [
        ...
        'correct_answer_no' => 4,
        'commentary' => 
        '中央処理装置とも訳されるコンピュータの情報処理の性能に影響する部分の略称はCPU(Central Processing Unit)である。
      ...
      [
        ...
        'correct_answer_no' => 4,
        'commentary' => 
        'ハードディスクドライブはPCに内蔵されている円盤状の磁気ディスクで情報を記録し読み出す代表的な記憶装置の一つである。
      ...
      [
        ...
        'correct_answer_no' => 1,
        'commentary' => 
        'アメリカのマーク・ザッカーバーグらによって開設された国際的なSNSはFacebook(フェイスブック)である。
      ...
      [
        ...
        'correct_answer_no' => 1,
        'commentary' => 
        'インターネット上で自分の名前の代わりに表示するニックネームはハンドルネームである。
      ...
      [
        ...
        'correct_answer_no' => 2,
        'commentary' => 
        'Internet Explorerはマイクロソフト社製のWEBブラウザである。
      ...
      [
        ...
        'correct_answer_no' => 1,
        'commentary' => 
        '発がん性や催奇形性を有し、人類が作った最悪と呼ばれる毒物はダイオキシンである。
      ...
      [
        ...
        'correct_answer_no' => 3,
        'commentary' => 
        '国内総生産が正解である。国内総生産はは、一定期間内に国内で産み出された付加価値の総額のことである。
      ...
      [
        ...
        'correct_answer_no' => 2,
        'commentary' => 
        'M&Aが正解である。M&Aとは、企業の合併や買収の総称である。
